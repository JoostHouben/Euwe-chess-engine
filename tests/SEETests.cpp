...
auto testCases = ::testing::Values(
        ...
        SEETestConfig{
                ...
                .move =
                        Move{.pieceToMove = Piece::Rook,
                             ...
                             .to          = BoardPosition::D5,
                             .flags       = MoveFlags::IsCapture},
                .expectedScore = getPieceValue(Piece::Pawn) - getPieceValue(Piece::Rook)},
        SEETestConfig{
        ...
        SEETestConfig{
                ...
                .move =
                        Move{.pieceToMove = Piece::Bishop,
                             ...
                             .to          = BoardPosition::D5,
                             .flags       = MoveFlags::IsCapture},
                .expectedScore = getPieceValue(Piece::Pawn) - getPieceValue(Piece::Bishop)},
        SEETestConfig{
                ...
                .move =
                        Move{.pieceToMove = Piece::Queen,
                             ...
                             .to          = BoardPosition::D5,
                             .flags       = MoveFlags::IsCapture},
                .expectedScore = getPieceValue(Piece::Pawn) - getPieceValue(Piece::Queen)},
        SEETestConfig{
        ...
        SEETestConfig{
                ...
                .move = Move{.pieceToMove = Piece::Rook, .from = BoardPosition::D3, .to = BoardPosition::D5, .flags = MoveFlags::IsCapture},
                .expectedScore = getPieceValue(Piece::Pawn) + getPieceValue(Piece::Knight)
                               - getPieceValue(Piece::Rook)},
